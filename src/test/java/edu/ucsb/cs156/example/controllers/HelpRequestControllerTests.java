...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_helprequest() throws Exception {
                ...
                LocalDateTime time2 = LocalDateTime.parse("2022-03-11T00:00:00");
        ...
        public void an_admin_user_can_post_a_new_ucsbdate() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/HelpRequest/post?requesterEmail=anouki@ucsb.edu&tableOrBreakoutRoom=a&explanation=help&teamId=1&requestTime=2022-01-03T00:00:00&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_helprequest() throws Exception {
                ...
                LocalDateTime time1 = LocalDateTime.parse("2022-01-03T00:00:00");
                LocalDateTime time2 = LocalDateTime.parse("2023-01-03T00:00:00");

                HelpRequest helpRequestOrig = HelpRequest.builder()
                                .requesterEmail("anouki@ucsb.edu")
                                .teamId("1")
                                .tableOrBreakoutRoom("a")
                                .explanation("helptest")
                                .requestTime(time1)
                                .solved(false)
                                .build();

                HelpRequest helpRequestEdited = HelpRequest.builder()
                                .requesterEmail("anouki@gmail.com")
                                .teamId("2")
                                .tableOrBreakoutRoom("B")
                                .explanation("helpcommand")
                                .requestTime(time2)
                                .solved(true)
                                .build();
